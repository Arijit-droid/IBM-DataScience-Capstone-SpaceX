...
# Plot 3: Bar chart for average number of vehicles sold by vehicle type in the selected year
...
# Plot 4: Total Advertisement Expenditure for each vehicle using pie chart in the selected year
...
# TASK 2.6: Returning the graphs for displaying Yearly data in 2x2 grid
        return [
